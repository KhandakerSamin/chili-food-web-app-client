        ...
        <div>
            ...
            <div className='bg-cover my-1 h-[460px] rounded-2xl mt-20 w-4/5 mx-auto' style={bannerStyle}>
                <div>
                    ...
                    <h1 className='text-white text-center font-bold mb-10 text-3xl md:text-5xl'>BOOK YOUR TABLE</h1>
                    ...
                    <div className='flex justify-center items-center gap-x-7 mx-10 mb-4'>
                    <input type="text" placeholder="Booking Time" className="input input-bordered w-full max-w-xs" />
                        <input type="Submit" placeholder="Booking Date" className="input btn block md:hidden btn-outline border-none text-white normal-case bg-yellow-600 w-full max-w-xs" />
                        <button className="btn border-none hidden md:block btn-outline text-base md:text-xl font-bold bg-yellow-600 text-white border border-black normal-case w-1/2 md:w-[320px]">Find your table</button>
                    </div>
                </div>
            </div>
        </div>
