...
const MyCart = () => {
    ...
    return (
        <div>
            ...
            <div>
                <h1 className='text-5xl my-8 font-bold bg-red-100 rounded-2xl m-5 py-4 text-center'>Your Ordered Foods Count : {myCart.length} </h1>
            </div>

            <div className='grid grid-cols-1 lg:grid-cols-2 mx-12 gap-10'>
                {
